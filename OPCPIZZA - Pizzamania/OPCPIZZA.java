/*
* Project name : SPOJ: OPCPIZZA - Pizzamania
* Author       : Wojciech Raszka
* E-mail       : gitpistachio@gmail.com
* Date created : 2019-06-20
* Description  :
* Status       : Accepted (23947870)
...
final class MATHII{
  ...
  public static void main(String args[]) throws IOException{
    ...
    int T = r.nextPositiveInt(), n, d;
    int[] A = new int[MAX_SIZE];
    int cnt;

    while (T-- > 0) {
      n = r.nextPositiveInt(); d = r.nextInt();
      for (int i = 0; i < n; i++) {
        A[i] = r.nextInt();
      }
      ...
      cnt = 0;
      for (int i = 0; i < n - 1; i++) {
        if (binary_search(A, i + 1, n - 1, d - A[i])) {
          cnt++;
        }
      }
