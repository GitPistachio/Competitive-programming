...
final class MATEX{
  ...
  public static long[] naiveVectorSquareMatrixMultiplication(long V[], long B[][], int n, long p) {
    long[] C = new long[n];
  ...
  public static long iterativeMatrixExpotentationOptimizedGreed(int row, int col, int n, long m, long p) {
    long[] V;
    int i = 0;
    long a = 0;
    ...
    while (m > 0) {
      ...
      i++;
      if ((m & 1) == 1) {
        V = naiveVectorSquareMatrixMultiplication(V, L[i], n, p);
      }
    }
  ...
  public static void main(String args[]) throws IOException{
    ...
    final int max_no_of_queries = 9000;
    ...
    for (int i = 0; i < max_no_of_queries; i++) {
      ...
      sb.append(iterativeMatrixExpotentationOptimizedGreed(row, col, n, m, p));
      sb.append('\n');
    }
